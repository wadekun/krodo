...
完整的阶段性路线图(Phase 0 → Phase 5)、每个任务的产出与验收标准,已提取到
独立文档:**[`docs/roadmap.md`](roadmap.md)**。

简要状态:

- **Phase 0**(验证想法)✅ 完成
- **Phase 1**(可用 CLI MVP)✅ 完成 — v0.1.0 发布、PyPI 上线(Trusted Publishers)
- **Phase 2**(代码理解 + TUI + MCP)— 未开始
- **Phase 3**(沙箱 + 评估 + OTEL)— 未开始
- **Phase 4**(生产级)— 未开始
- **Phase 5**(生态,可选)— 未开始

后续路线图更新直接改 `docs/roadmap.md`;架构设计变更改本文档。
