...
[krodo.core.loop.AgentLoop] docstring).
...
async def run_repl(components: SessionComponents) -> str | None:
    ...
    # ------------------------------------------------------------------
    from krodo.cli.main import print_session_summary  # noqa: PLC0415
...
def _dispatch_slash(command: str, components: SessionComponents) -> str | None:
    ...
    if cmd == ":sessions":
        from krodo.cli.resume import render_sessions_table  # noqa: PLC0415
    ...
    if cmd == ":undo":
        ...
        from krodo.cli.undo import undo_command  # noqa: PLC0415
    ...
    if cmd == ":cost":
        from krodo.obs.cost import format_token_count  # noqa: PLC0415
