;; ---------------------------------------------------------------------------
;; typescript-tags.scm — tree-sitter tag query.
;; ---------------------------------------------------------------------------
;; Source:      Aider <aider/queries/tree-sitter-language-pack/typescript-tags.scm>
...
;; Local modifications: adapted — Aider ships no typescript-tags.scm; body is the javascript query verbatim (TS grammar is a JS superset) plus TS-only interface/type_alias/enum patterns added below.
;;
...
;; --- TypeScript-only additions (interfaces, type aliases, enums) ---
;; Verified against the tree-sitter-typescript grammar; TS is a superset of
;; the JS grammar for the function/class/method/call patterns above, which is
;; why the JS body is reused verbatim. The additions below use node types
;; exclusive to the TS grammar.
