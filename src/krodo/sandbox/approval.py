...
The user can answer 'p' to enter a pattern rule such as:
    ...
    read_file src/krodo/*      — trust read_file calls for paths matching the glob
...
class TerminalApprovalManager:
    ...
    def restore_state(self, state: dict[str, Any]) -> None:
        """Re-apply a previously exported snapshot (used by ``krodo resume``).
    ...
    def _maybe_render_diff(tool_call: ToolCall, console: object) -> None:
        ...
        if name == "write_file":
            ...
            from krodo.cli.diff_preview import render_diff  # noqa: PLC0415
