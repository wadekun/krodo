...
Mapping table (see M5.2 spec):
  ...
  INDEX_BUILD / INDEX_UPDATE / REPO_MAP
                    → skip (metadata only)
"""
...
from krodo.core.types import Message, SessionEventType, ToolResult

if TYPE_CHECKING:
    from krodo.core.context import InMemoryContextManager
    from krodo.core.types import SessionEvent
...
def replay_events(
    ...
    for event in sorted_events:
        ...
        if et == SessionEventType.SESSION_INIT:
            ...
            from krodo.core.types import ToolCall  # noqa: PLC0415
        ...
        # COST_SNAPSHOT, INDEX_BUILD, INDEX_UPDATE, REPO_MAP) are metadata-only — skip.
