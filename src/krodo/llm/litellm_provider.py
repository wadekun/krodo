...
from krodo.core.types import LLMChunk, Message, ToolCall, ToolDef, ToolResult


def _message_to_litellm(msg: Message) -> dict[str, Any]:
    """Convert a Krodo Message to a LiteLLM-compatible dict."""
...
def _litellm_to_message(raw: Any, stop_reason: str | None = None) -> Message:
    """Convert a LiteLLM response message to a Krodo Message.
