...
from krodo.obs.cost import CostTracker, estimate_cost_usd
from krodo.sandbox.protocols import ApprovalManager
...
_DEFAULT_SYSTEM_PROMPT = (
    "You are Krodo, a local-first coding agent operating strictly inside the "
    "user's workspace.\n\n"
    "Available tools:\n"
    "{tool_list}\n\n"
    "Hard rules:\n"
...
class AgentLoop:
    ...
    async def _run_loop(self) -> TurnResult:  # noqa: C901
        ...
        while True:
            ...
            # LLM round of this session AND any later `krodo resume`.
            # ----------------------------------------------------------------
